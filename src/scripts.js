...
~function(){
        ...
        if(m && m.length > 1){
            ...
            var inject_html = ' \
                <div class="fn" id="fn_play_iku"> \
                    <div class="handle" ><a id="fn_play_iku_a" href="' + _genInjectUrl(m[1]) + '">播放</a></div> \
                </div> \
            ';
    ...
    function addWeiboSpecBtn(node, vid){
        var inject_html = '<a class="W_btn_a" name="iku_play" href="' + _genInjectUrl(vid) + '"><span class="btn_26px">iku播放</span></a>';
